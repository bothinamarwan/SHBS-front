...
@Component({
  selector: 'app-landlord-notifications',
  standalone: true,
  imports: [CommonModule],
  templateUrl: './landlord-notifications.html'
})
export class LandlordNotifications implements OnInit {
  ...
  loadNotifications() {
    ...
    const userId = user?.landlordId || user?.id;
